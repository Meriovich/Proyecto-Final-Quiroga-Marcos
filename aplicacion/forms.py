...
from aplicacion.models import Servidor
...
class FormularioNuevoServidor(forms.ModelForm):
    class Meta:
        model = Servidor
        fields = ('usuario', 'titulo', 'juego', 'ip')
...
class ActualizacionServidor(forms.ModelForm):
    class Meta:
        model = Servidor
        fields = ('titulo', 'juego', 'ip')
